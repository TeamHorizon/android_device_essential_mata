...
/dev/block/bootdevice/by-name/userdata   /data              ext4   noatime,nosuid,nodev,barrier=1,noauto_da_alloc,journal_async_commit,data=writeback,discard,commit=300   latemount,wait,check,formattable,reservedsize=128M,fileencryption=ice,quota
